    ...
    <>
      <nav className="flex items-center justify-between py-3 px-6 bg-gray-900 text-white">
        ...
        <div className="hidden md:flex space-x-8 ml-20">
          <a href="/find-jobs" className="text-white hover:text-orange-400 font-medium">
            Find Jobs
          </a>
          <a href="/people" className="text-white hover:text-orange-400 font-medium">
            People
          </a>
          <a href="/education" className="text-white hover:text-orange-400 font-medium">
            Education
          </a>
          <a href="/blog" className="text-white hover:text-orange-400 font-medium">
            Blog
          </a>
        </div>
        ...
        <div className="flex items-center space-x-6">
          ...
          {!user && (
            <div className="flex space-x-4">
              <a href="/signup" className="border border-white text-white px-4 py-1.5 rounded hover:bg-white hover:text-gray-900 transition">
                Sign Up
              </a>
              <a href="/signin" className="bg-white text-gray-900 px-4 py-1.5 rounded hover:bg-gray-200 transition">
                Sign In
              </a>
            </div>
          )}
